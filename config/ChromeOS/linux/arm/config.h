...
#define FFMPEG_CONFIGURATION "--disable-everything --disable-network --disable-bzlib --disable-zlib --disable-swscale --enable-shared --enable-decoder='theora,vorbis,pcm_u8,pcm_s16le,pcm_f32le,aac,h264,mp3,wmv1,wmv2,wmv3,wmav1,wmav2,wmapro,mpeg4,pcm_u8,pcm_s16le,pcm_f32le' --enable-demuxer='ogg,matroska,wav,mp3,mov,avi,wav,asf' --enable-parser=mpegaudio --enable-bsf='h264_mp4toannexb,mpeg4video_es,vc1_asftorcv,vc1_asftoannexg' --enable-cross-compile --arch=arm --target-os=linux --enable-armv6 --enable-armv6t2 --enable-armvfp --disable-neon --cross-prefix=/usr/local/google/cross-tools/arm-2009q3/bin/arm-none-linux-gnueabi- --extra-cflags='-march=armv7-a -mtune=cortex-a8 -mfpu=vfp -mfloat-abi=softfp'"
